<!DOCTYPE html>
<html lang="en-US" prefix="og: http://ogp.me/ns#"><!-- Mirrored from html.physcode.com/travel/travel-tips.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Mar 2017 05:00:19 GMT -->

    <!-- Mirrored from jahongir-travel.uz/aboutus.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 15:26:46 GMT -->
    <!-- Added by HTTrack -->
    <meta
    ...
    <head>
        ...
        <title>About our travel company Jahongir Travel and our Services
        </title>
...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <link rel="stylesheet" href="thumbnail-gallery.html">
        ...
        <div class="wrapper-container">
                                    ...
                                    <div class="textwidget">
                                        <ul class="top_bar_info clearfix">
                                            <li>
                                                ...
                                                Mon - Sun 08.00 - 18.00</li>
                                            <li>
                                                <i class="fa fa-envelope-o"></i>info@jahongir-travel.uz</li>
                                        </ul>
                                    ...
                                    <div class="textwidget">
                                        <ul class="top_bar_info clearfix">
                                            ...
                                            <li class="hidden-info">
                                                ...
                                                4 Chirokchi str., Samarkand, Uzbekistan
                                            </li>
                                        </ul>
                                    </div>
                                </aside>
                ...
                <div class="navigation-menu">
                    <div class="container">
                        ...
                        <div class="width-logo sm-logo">
                            <a href="index.html" title="Jahongir Travel" rel="home">
                        ...
                        <nav class="width-navigation">
                            <ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
                                ...
                                <li class="menu-item-has-children current-menu-parent">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="tours-from-khiva/tour-from-khiva-ancient-fortresses.html">Tours from Khiva</a>
                                        </li>
                                        <li>
            ...
            <div class="wrapper-footer wrapper-footer-newsletter">
                <div class="main-top-footer">
                    <div class="container">
                        <div class="row">
                            <aside class="col-sm-6 widget_text">
                                    ...
                                    <div class="footer-info">
                                        ...
                                        <ul class="contact-info">
                                            <li>
                                                ...
                                                4 Chirokchi str., Samarkand, Uzbekistan</li>
                                            <li>
                                                <i class="fa fa-whatsapp fa-fw"></i>
                                                +998 91 555 0808</li>
                                            <li>
                                                <i class="fa fa-envelope fa-fw"></i>
                                                <a href="mailto:info@jahongir-travel.com">info@jahongir-travel.com</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <aside class="col-sm-6 widget_text">
                                ...
                                <div class="textwidget">
                                    <ul class="menu list-arrow">
                                        ...
                                        <li>
                                            <a href="index.html">Samarkand Tours</a>
                                        </li>
                ...
                <div class="container wrapper-copyright">
                    <div class="row">
                        <div class="col-sm-6">
                            <div>
                                <p>Copyright © 2019 Jahongir Travel. All Rights Reserved.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
