            ...
            <div class="block-content">
                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('tour_title') }}" class="form-control  @error('tour_title')  {{ 'is-invalid' }} @enderror "
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('tour_duration') }}" class="form-control  @error('tour_duration')  {{ 'is-invalid' }} @enderror "
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control  @error('tour_description')  {{ 'is-invalid' }} @enderror " id="example-textarea-input" name="tour_description" rows="4"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('tour_start_end_points') }}" class="form-control  @error('tour_start_end_points')  {{ 'is-invalid' }} @enderror "
                                   id="example-text-input" name="tour_start_end_points" placeholder="Tour Start end Points">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('tour_departure_time') }}" class="form-control  @error('tour_departure_time')  {{ 'is-invalid' }} @enderror "
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" value="{{ old('tour_file') }}" name="tour_file" class="form-control @error('tour_file')
                {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" >
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('tour_code') }}" class="form-control  @error('tour_code')  {{ 'is-invalid' }} @enderror "
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('tour_location') }}" class="form-control  @error('tour_location')  {{ 'is-invalid' }} @enderror "
